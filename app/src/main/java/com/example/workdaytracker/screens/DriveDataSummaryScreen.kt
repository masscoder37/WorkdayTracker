...
fun DriveDataSummaryScreen(navController: NavController) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column {
            ...
            val avgWorkFuelString = String.format("%0.1d L", avgWorkFuelCons)
            val avgHomeFuelString = String.format("%0.1d L", avgHomeFuelCons)
            ...
            LazyColumn(modifier = Modifier
                ...
                //Day with most average duration
                item {
                    Text(
                ...
                //day with least average duration
                item {
                    Text(
